...
const triageFlows = {
    ...
    'patch-yes': {
        ...
        message: 'Execute a atualização para a versão corrigida imediatamente. Como existe um patch oficial sem Breaking Changes, a correção deve ser aplicada seguindo o ciclo normal de desenvolvimento.',
    ...
    'function-used': {
        question: 'Existe alternativa viável no socket.dev (score > 85)?',
    ...
    'alternative-yes': {
        ...
        message: 'Migre para a alternativa identificada no socket.dev. Execute a substituição conforme análise de esforço e compatibilidade funcional.',
    ...
    'time-low': {
        ...
        message: 'O esforço de correção é aceitável (< 16h). Execute a correção ou refatoração necessária para eliminar a vulnerabilidade.',
        color: 'var(--primary-blue)',
        bgColor: 'rgba(99, 102, 241, 0.1)'
    },
    'time-high': {
    ...
    'not-used-low': {
        ...
        message: 'A função vulnerável não é utilizada e o CVSS é baixo. Status: not_affected. Execute a tarefa normalmente, mas mantenha monitoramento periódico.',
    ...
    'not-used-high': {
        ...
        message: 'A função não é utilizada, mas o CVSS é alto (≥ 7.0). Registre Waiver no Git e OpenProject com justificativa técnica completa. Status: not_affected. Prazo de reavaliação: 10 dias.',
    ...
    'high-effort-medium': {
        ...
        message: 'CVSS Médio (4.0-6.9) + esforço alto (≥ 16h). Waiver permitido com justificativa de custo elevado. Registre no Git e OpenProject. Prazo de reavaliação: 10 dias.',
        color: 'var(--primary-blue)',
        bgColor: 'rgba(99, 102, 241, 0.1)'
    },
    'high-effort-high': {
        ...
        message: 'CVSS Alto (7.0-8.9) + esforço alto. Waiver temporário exige busca obrigatória de alternativa no socket.dev. Documente a inexistência de alternativas viáveis. Prazo: 10 dias.',
        color: 'var(--accent-gold)',
        bgColor: 'rgba(245, 158, 11, 0.1)'
    },
    'high-effort-critical': {
        ...
        message: 'CVSS Crítico (≥ 9.0) detectado. ESCALONAMENTO OBRIGATÓRIO para o Time de Segurança. Altere status no OpenProject para [Em Revisão]. Waiver só é válido após aprovação do revisor.',
    ...
    'healthy': {
        ...
        message: 'A biblioteca está sem vulnerabilidades conhecidas e mantida ativamente. Execute a tarefa normalmente seguindo o fluxo de desenvolvimento padrão.',
        color: 'var(--status-success)',
        bgColor: 'rgba(34, 197, 94, 0.1)'
    },
    'obsolete': {
        ...
        message: 'A biblioteca está obsoleta (sem manutenção > 12 meses). Busque alternativa no socket.dev com score de manutenção > 85 antes de prosseguir com a tarefa.',
        color: 'var(--accent-gold)',
        bgColor: 'rgba(245, 158, 11, 0.1)'
    }
};
...
function updateBreadcrumb() {
    ...
    if (triagePath.length > 0) {
        ...
        breadcrumbText.textContent = triagePath.join(' → ');
    }
}
